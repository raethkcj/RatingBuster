...
addon.CritPerAgi = {
	["WARRIOR"] = {
		...
		0.1852, 0.1786, 0.1667, 0.1613, 0.1563, 0.1515, 0.1471, nil,    nil,    0.1282,
		0.1282, nil,    nil,    nil,    0.1111, 0.1087, 0.1064, 0.1020, 0.1000, 0.0962,
		0.0943, 0.0926, 0.0893, 0.0877, 0.0847, 0.0833, 0.0820, 0.0794, 0.0781, 0.0758,
		[60] = 0.0500,
	},
	["PALADIN"] = {
		0.2150, 0.2048, 0.2048, 0.1955, 0.1955, 0.1870, nil,    nil,    nil,    nil,
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    0.1303, nil,    nil,
		nil,    nil,    nil,    nil,    0.1075, 0.1049, 0.1024, 0.1000, 0.0977, 0.0935,
		0.0915, 0.0915, 0.0878, 0.0860, 0.0827, 0.0811, 0.0811, 0.0782, 0.0768, 0.0741,
		[60] = 0.0506,
	},
	["HUNTER"] = {
		0.2174, 0.2083, 0.2000, 0.1852, 0.1786, 0.1724, nil,    nil,    nil,    nil,
		0.1351, nil,    0.1087, 0.1000, nil,    nil,    0.0806, nil,    nil,    nil,
		0.0633, nil,    0.0568, nil,    0.0515, 0.0495, 0.0472, 0.0455, 0.0435, 0.0417,
		0.0407, 0.0391, 0.0376, 0.0365, nil,    nil,    0.0331, 0.0321, 0.0311, 0.0303,
		[60] = 0.0189,
	},
	["ROGUE"] = {
		0.4348, 0.4167, 0.4000, 0.3704, 0.3571, nil,    nil,    0.3125, 0.3030, 0.2857,
		0.2564, 0.2326, 0.2083, nil,    nil,    nil,    nil,    nil,    nil,    nil,
		nil,    nil,    0.1053, nil,    0.0952, 0.0909, 0.0877, 0.0840, 0.0806, 0.0769,
		0.0746, 0.0719, 0.0694, 0.0671, 0.0645, 0.0625, 0.0610, 0.0592, 0.0575, 0.0556,
		[60] = 0.0345,
	},
	["PRIEST"] = {
		0.1000, 0.1000, 0.1000, nil,    nil,    0.0952, 0.0952, nil,    nil,    nil,
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,
		0.0800, nil,    nil,    nil,    0.0769, 0.0741, 0.0741, 0.0741, 0.0714, 0.0714,
		0.0714, 0.0690, 0.0690, 0.0690, 0.0667, 0.0667, 0.0667, nil,    nil,    0.0645,
		[60] = 0.0500,
	},
	["SHAMAN"] = {
		[25] = 0.0971,
	...
	["MAGE"] = {
		nil,    nil,    nil,    0.0857, 0.0857, 0.0857, 0.0857, 0.0857, 0.0857, 0.0818,
		0.0818, nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,
		nil,    0.0750, 0.0750, 0.0720, 0.0720, 0.0720, 0.0720, 0.0720, 0.0692, 0.0692,
		0.0692, 0.0692, 0.0667, 0.0667, 0.0667, 0.0643, 0.0643, 0.0643, 0.0643, 0.0621,
		[60] = 0.0514,
	},
	["WARLOCK"] = {
		nil,    nil,    0.1429, 0.1429, 0.1429, 0.1364, 0.1364, 0.1364, 0.1304, 0.1304,
		0.1250, 0.1250, nil,    nil,    nil,    nil,    nil,    nil,    0.1071, 0.1034,
		0.1000, 0.1000, nil,    nil,    0.0909, 0.0909, 0.0909, 0.0882, 0.0882, 0.0833,
		0.0833, 0.0811, 0.0811, 0.0789, 0.0769, nil,    0.0732, 0.0732, nil,    0.0698,
		[60] = 0.0500,
	},
	["DRUID"] = {
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    0.1281, nil,    nil,
		nil,    0.1108, nil,    nil,    0.1025, 0.1025, 0.1000, 0.0976, 0.0976, 0.0891,
		0.0872, 0.0872, 0.0854, 0.0837, 0.0820, 0.0804, 0.0788, 0.0788, nil,    0.0719,
		[60] = 0.0500,
	},
}
...
addon.SpellCritPerInt = {
	["WARRIOR"] = addon.zero,
	["PALADIN"] = {
		0.0750, 0.0714, 0.0714, 0.0682, 0.0682, 0.0652, nil,    nil,    nil,    nil,
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    0.0441, nil,    nil,
		nil,    nil,    nil,    nil,    0.0357, 0.0349, 0.0349, 0.0333, 0.0326, 0.0313,
		0.0306, 0.0300, 0.0294, 0.0288, 0.0278, 0.0273, 0.0268, 0.0259, 0.0254, 0.0246,
		[60] = 0.0167,
	},
	["HUNTER"] = {
		0.0700, 0.0667, 0.0667, 0.0636, 0.0636, 0.0609, nil,    nil,    nil,    nil,
		0.0560, nil,    0.0500, 0.0500, nil,    nil,    0.0452, nil,    nil,    nil,
		0.0389, nil,    0.0368, nil,    0.0350, 0.0341, 0.0333, 0.0326, 0.0318, 0.0304,
		0.0298, 0.0298, 0.0286, 0.0280, nil,    nil,    0.0264, 0.0255, 0.0250, 0.0241,
		[60] = 0.0165,
	},
	["ROGUE"] = addon.zero,
	["PRIEST"] = {
		0.1909, 0.1826, 0.1750, nil,    nil,    0.1500, 0.1448, nil,    nil,    nil,
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,
		0.0560, nil,    nil,    nil,    0.0457, 0.0438, 0.0420, 0.0404, 0.0389, 0.0372,
	...
	["MAGE"] = {
		nil,    nil,    nil,    0.1655, 0.1600, 0.1548, 0.1500, 0.1455, 0.1371, 0.1333,
		0.1231, nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,
		nil,    0.0539, 0.0522, 0.0495, 0.0475, 0.0457, 0.0436, 0.0397, 0.0381, 0.0366,
		0.0358, 0.0345, 0.0336, 0.0327, 0.0316, 0.0308, 0.0298, 0.0291, 0.0282, 0.0276,
		[60] = 0.0168,
	},
	["WARLOCK"] = {
		nil,    nil,    0.1375, 0.1320, 0.1269, 0.1222, 0.1179, 0.1138, 0.1100, 0.1065,
		0.0971, 0.0892, nil,    nil,    nil,    nil,    nil,    nil,    0.0569, 0.0541,
		0.0516, 0.0493, nil,    nil,    0.0429, 0.0418, 0.0398, 0.0384, 0.0367, 0.0355,
		0.0347, 0.0333, 0.0324, 0.0311, 0.0303, nil,    0.0284, 0.0277, nil,    0.0262,
		[60] = 0.0165,
	},
	["DRUID"] = {
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,    nil,
		nil,    nil,    nil,    nil,    nil,    nil,    nil,    0.0604, nil,    nil,
		nil,    0.0485, nil,    nil,    0.0427, 0.0416, 0.0400, 0.0390, 0.0372, 0.0352,
		0.0344, 0.0330, 0.0323, 0.0314, 0.0302, 0.0296, 0.0288, 0.0281, nil,    0.0260,
		[60] = 0.0167,
	},
}
