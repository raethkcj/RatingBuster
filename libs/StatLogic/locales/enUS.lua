...
L["%s attack power & %s mana per %s seconds"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.ManaRegen, false, }
L["%s attack power and %s mana every %s seconds"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.ManaRegen, false, }
