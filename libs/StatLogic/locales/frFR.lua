...
D[StatLogic.Stats.Defense] = {"Défense", "Défense"}
D[StatLogic.Stats.Dodge] = {"Esquive (%)", "Esquive (%)"}
D[StatLogic.Stats.Parry] = {"Parade (%)", "Parade (%)"}
D[StatLogic.Stats.BlockChance] = {"Blocage (%)", "Blocage (%)"}
...
D[StatLogic.Stats.Miss] = {"Score d'évitement des coups en mêlée (%)", "Évi. des coups (mêlée)(%)"}
D[StatLogic.Stats.MeleeCrit] = {"Critiques (%)", "Crit.(%)"}
D[StatLogic.Stats.RangedCrit] = {"Critiques à distance (%)", "Crit. (dist.)(%)"}
D[StatLogic.Stats.SpellCrit] = {"Critiques des sorts (%)", "Crit. (sorts)(%)"}
