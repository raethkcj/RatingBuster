...
L["permanently enchant a melee weapon to do %s additional points of damage"] = { { Stats.AverageWeaponDamage, }, } -- s22095
...
L["给你的头部或腿部装备附加魔法效果，使冰霜抗性提高%s点。无法与其它附加于指定装备的魔法效果重叠。"] = { { Stats.FrostResistance, }, } -- s28163
...
L["永久性地为一件肩部装备附魔，使其获得攻击强度%s点，以及爆击几率提高%s%的属性。"] = { { Stats.AttackPower, Stats.RangedAttackPower, }, { Stats.MeleeCrit, Stats.RangedCrit, }, } -- s29483
...
L["对目标武器使用时，每%s秒恢复%s点法力值，使法术命中几率提高%s%，持续%s分钟。该效果仅在黑暗深渊中生效。"] = { false, { Stats.GenericManaRegen, }, { Stats.SpellHit, }, false, } -- s430585
...
L["永久性地为一件肩部装备附魔，使其获得攻击强度提高%s点的效果。"] = { { Stats.AttackPower, Stats.RangedAttackPower, }, } -- s446451
L["永久性地为一件肩部物品附魔，使其获得法术和魔法效果造成的伤害和治疗提高最多%s点的属性。"] = { { Stats.SpellPower, }, } -- s446459
L["提高法术和效果造成的治疗，最多%s点。"] = { { Stats.HealingPower, }, } -- s446470
L["永久性地为一件肩部物品附魔，使其获得法术和效果造成的治疗提高最多%s点的效果。"] = { { Stats.HealingPower, }, } -- s446472
...
L["永久性地为一件腿部或头部装备附魔，使其获得耐力提高%s点，力量提高%s点，法术伤害和治疗效果提高%s点的效果。无法与其它附加于指定装备的魔法效果重叠。"] = { { Stats.Stamina, }, { Stats.Strength, }, { Stats.SpellPower, }, } -- s468330
L["永久性地为一件腿部或头部装备附魔，使其获得耐力提高%s点，智力提高%s点，法术伤害和治疗效果提高%s点的效果。无法与其它附加于指定装备的魔法效果重叠。"] = { { Stats.Stamina, }, { Stats.Intellect, }, { Stats.SpellPower, }, } -- s468339
L["永久性地为一件腿部或头部装备附魔，使其获得耐力提高%s点，智力提高%s点，法师商家治疗效果提高%s点的效果。无法与其它附加于指定装备的魔法效果重叠。"] = { { Stats.Stamina, }, { Stats.Intellect, }, { Stats.SpellPower, }, } -- s468344
L["永久性地为一件腿部或头部装备附魔，使其获得耐力提高%s点，敏捷提高%s点，防御提高%s点的效果。无法与其它附加于指定装备的魔法效果重叠。"] = { { Stats.Stamina, }, { Stats.Agility, }, { Stats.Defense, }, } -- s468347
...
L["对目标盾牌使用，使法术伤害和治疗效果提高最多%s点，法术爆击几率提高%s%。持续%s分钟。"] = { { Stats.SpellPower, }, { Stats.SpellCrit, }, false, } -- s471401
...
L["给一件护腕永久性地附魔，使装备它的人物获得敏捷提高%s点的效果。"] = { { Stats.Agility, }, } -- s1217203
...
L["永久性地为一件肩部装备附魔，使其获得法术的治疗效果提高最多%s点，以及每%s秒回复%s点法力值的效果。"] = { { Stats.GenericManaRegen, }, false, false, } -- s1219507
L["永久性地为一件肩部装备附魔，使其获得法术的伤害和治疗效果提高最多%s点，以及法术的爆击几率提高%s%的效果。"] = { { Stats.SpellPower, }, { Stats.SpellCrit, Stats.MeleeCrit, Stats.RangedCrit, }, } -- s1219510
L["永久性地为一件肩部装备附魔，使其获得耐力%s点和防御%s的效果。"] = { { Stats.Stamina, }, { Stats.Defense, }, } -- s1219511
L["永久性地为一件肩部装备附魔，使其获得攻击强度%s点，以及爆击几率提高%s%的效果。"] = { { Stats.GenericAttackPower, Stats.AttackPower, Stats.RangedAttackPower, }, { Stats.MeleeCrit, Stats.RangedCrit, Stats.SpellCrit, }, } -- s1219512
...
L["永久性地为一件副手物品附魔，使其获得智力%s点的效果。"] = { { Stats.Intellect, }, } -- s1219577
L["永久性地为一件副手物品附魔，使其获得精神%s点的效果。"] = { { Stats.Spirit, }, } -- s1219578
...
L["击中时有几率使你的力量提高%s点，移动速度提高%s%，持续%s秒。"] = { { Stats.Strength, }, false, false, ignoreSum = true } -- s1223341
L["如果你花费至少%s秒进食，你将获得进食充分效果，力量提高%s点，耐力提高%s点，持续%s分钟。"] = { false, { Stats.Strength, }, { Stats.Stamina, }, false, } -- s1225778
