...
L["regeneración de maná: %s cada %s s"] = {StatLogic.Stats.GenericManaRegen, false, }
L["defensa %s/aguante %s /valor de bloqueo %s"] = {StatLogic.Stats.Defense, StatLogic.Stats.Stamina, StatLogic.Stats.BlockValue, }
L["defensa %s/aguante %s /hechizos de sanación %s"] = {StatLogic.Stats.Defense, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
...
L["regeneración de maná %s/aguante %s/hechizos de sanación %s"] = {StatLogic.Stats.GenericManaRegen, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
L["intelecto %s/aguante %s/hechizos de sanación %s"] = {StatLogic.Stats.Intellect, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
...
L["%s poder de ataque %s índice de golpes"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.HitRating, }
...
L["restaura %s p. de maná cada %s s a todos los miembros del grupo en un radio de %s m"] = {StatLogic.Stats.GenericManaRegen, false, false, }
...
L["aumenta un máximo de %s p. el daño y la sanación de los efectos y hechizos mágicos de los miembros del grupo que están en un radio de %s m. las distintas fuentes de este efecto específico no se acumulan"] = {{StatLogic.Stats.HealingPower, StatLogic.Stats.SpellDamage, }, false, }
L["aumenta un máximo de %s p. la sanación realizada y un máximo de %s p. el daño infligido de los efectos y hechizos mágicos de todos los miembros del grupo que están en un radio de %s. las distintas fuentes de este efecto específico no se acumulan"] = {StatLogic.Stats.HealingPower, StatLogic.Stats.SpellDamage, false, }
L["aumenta un %s% la velocidad de lanzamiento de todos los miembros del grupo que están en un radio de %s m. las distintas fuentes de este efecto específico no se acumulan"] = {StatLogic.Stats.SpellHaste, false, }
L["aumenta un %s% la probabilidad de golpe crítico de todos los miembros del grupo que están en un radio de %s m. las distintas fuentes de este efecto específico no se acumulan"] = {StatLogic.Stats.SpellCrit, false, }
L["aumenta un %s% la velocidad de lanzamiento de hechizos que no se canalizan"] = {StatLogic.Stats.SpellHaste, }
...
L["aumenta hasta %s p. la sanación realizada y hasta %s p. el daño que infligen todos los efectos y hechizos mágicos"] = {StatLogic.Stats.HealingPower, StatLogic.Stats.SpellDamage, }
