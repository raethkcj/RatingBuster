...
L["%s índice de golpe crítico y %s penetración de hechizos"] = {StatLogic.Stats.CritRating, false, }
...
L["%s índice de celeridad y %s penetración de hechizos"] = {StatLogic.Stats.HasteRating, false, }
