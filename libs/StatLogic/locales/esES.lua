...
L["%s poder de ataque y %s maná cada %s s"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.ManaRegen, false, }
...
L["%s poder de ataque y %s maná cada %s segundos"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.ManaRegen, false, }
