...
D["EXPERTISE_RATING"] = {"Pericia".." "..RATING, "Pericia".." "..RATING}
D["ARMOR_PENETRATION_RATING"] = {"Penetración de Armadura".." "..RATING, "ArP".." "..RATING}
...
D["EXPERTISE"] = {"Pericia", "Pericia"}
D["ARMOR_PENETRATION"] = {"Penetr. Armadura(%)", "ArP(%)"}
