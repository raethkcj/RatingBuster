...
L["%s taxa de acerto crítico e %s penetração de feitiço"] = {StatLogic.Stats.CritRating, false, }
...
L["%s taxa de aceleração e %s penetração de feitiço"] = {StatLogic.Stats.HasteRating, false, }
