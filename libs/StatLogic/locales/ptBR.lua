...
W["vitalidade"] = {[StatLogic.Stats.GenericManaRegen] = 4, [StatLogic.Stats.HealthRegen] = 4, }
...
L["%s mana a cada %s s"] = {StatLogic.Stats.GenericManaRegen, false, }
L["defesa %s/vigor %s/valor de bloqueio %s"] = {StatLogic.Stats.Defense, StatLogic.Stats.Stamina, StatLogic.Stats.BlockValue, }
L["defesa %s/vigor %s/feitiços de cura %s"] = {StatLogic.Stats.Defense, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
...
L["regeneração de mana %s/vigor %s/feitiços de cura %s"] = {StatLogic.Stats.GenericManaRegen, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
L["intelecto %s/vigor %s/feitiços de cura %s"] = {StatLogic.Stats.Intellect, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
...
L["%s regeneração de mana/%s vigor/%s feitiços de cura"] = {StatLogic.Stats.GenericManaRegen, StatLogic.Stats.Stamina, StatLogic.Stats.HealingPower, }
...
L["%s mana restaurado a cada %s s"] = {StatLogic.Stats.GenericManaRegen, false, }
...
L["%s poder mágico, %s vigor e %s mana a cada %s s"] = {{StatLogic.Stats.SpellDamage, StatLogic.Stats.HealingPower, }, StatLogic.Stats.Stamina, StatLogic.Stats.GenericManaRegen, false, }
...
L["%s intelecto e %s mana a cada %s s"] = {StatLogic.Stats.Intellect, StatLogic.Stats.GenericManaRegen, false, }
L["%s poder mágico e %s vigor"] = {{StatLogic.Stats.SpellDamage, StatLogic.Stats.HealingPower, }, StatLogic.Stats.Stamina, }
L["%s poder mágico e %s mana a cada %s s"] = {{StatLogic.Stats.SpellDamage, StatLogic.Stats.HealingPower, }, StatLogic.Stats.GenericManaRegen, false, }
...
L["%s poder de ataque e pequeno aumento na velocidade de movimento"] = {StatLogic.Stats.GenericAttackPower, }
...
L["%s poder de ataque e %s taxa de acerto crítico"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.CritRating, }
L["%s poder mágico e pequeno aumento na velocidade de movimento"] = {{StatLogic.Stats.SpellDamage, StatLogic.Stats.HealingPower, }, }
L["%s taxa de acerto crítico e %s mana a cada %ss"] = {StatLogic.Stats.CritRating, StatLogic.Stats.GenericManaRegen, false, }
L["%s poder de ataque e %s taxa de acerto"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.HitRating, }
...
L["%s taxa de acerto crítico e %s mana a cada %s s"] = {StatLogic.Stats.CritRating, StatLogic.Stats.GenericManaRegen, false, }
...
L["%s poder de ataque e %s vigor"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.Stamina, }
...
L["%s poder de ataque e %s taxa de resiliência"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.ResilienceRating, }
...
L["%s taxa de defesa e %s mana a cada %s s"] = {StatLogic.Stats.DefenseRating, StatLogic.Stats.GenericManaRegen, false, }
...
L["%s taxa de acerto e %s de mana a cada %s s"] = {StatLogic.Stats.HitRating, StatLogic.Stats.GenericManaRegen, false, }
L["%s taxa de aparo e %s taxa de resiliência"] = {StatLogic.Stats.ParryRating, StatLogic.Stats.ResilienceRating, }
L["%s poder de ataque e %s mana a cada %s s"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.GenericManaRegen, false, }
L["%s taxa de acerto crítico e %s poder de ataque"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.CritRating, }
L["%s agilidade e %s% aumento no dano crítico"] = {StatLogic.Stats.Agility, false, }
L["%s poder de ataque e %s% resistência a atordoamento"] = {StatLogic.Stats.GenericAttackPower, false, }
L["%s poder mágico e %s% resistência a atordoamento"] = {{StatLogic.Stats.SpellDamage, StatLogic.Stats.HealingPower, }, false, }
L["%s mana a cada %s segundos"] = {StatLogic.Stats.GenericManaRegen, false, }
...
L["%s vida e mana a cada %s s"] = {{StatLogic.Stats.HealthRegen, StatLogic.Stats.GenericManaRegen, }, false, }
...
L["%s agilidade e %s mana a cada %s s"] = {StatLogic.Stats.Agility, StatLogic.Stats.GenericManaRegen, false, }
...
L["%s poder de ataque e %s taxa de aceleração"] = {StatLogic.Stats.GenericAttackPower, StatLogic.Stats.HasteRating, }
...
L["%s taxa de acerto e %s mana a cada %s s"] = {StatLogic.Stats.HitRating, StatLogic.Stats.GenericManaRegen, false, }
L["%s taxa de resiliência e %s mana a cada %s s"] = {StatLogic.Stats.ResilienceRating, StatLogic.Stats.GenericManaRegen, false, }
L["%s taxa de aceleração e %s mana a cada %s s"] = {StatLogic.Stats.HasteRating, StatLogic.Stats.GenericManaRegen, false, }
...
L["teste de %s intelecto e %s pontos de mana a cada %s segundos"] = {StatLogic.Stats.Intellect, StatLogic.Stats.GenericManaRegen, false, }
...
L["%s mana a cada %s s e efeito de cura crítica aumentado em %s%"] = {StatLogic.Stats.GenericManaRegen, false, false, }
...
L["%s poder de ataque e duração de atordoamento reduzida em %s%"] = {StatLogic.Stats.GenericAttackPower, false, }
L["%s poder mágico e duração de atordoamento reduzida em %s%"] = {{StatLogic.Stats.SpellDamage, StatLogic.Stats.HealingPower, }, false, }
L["%s poder de ataque e críticos às vezes curam"] = {StatLogic.Stats.GenericAttackPower, }
...
L["restaura %s de mana a cada %s s de todos os integrantes do grupo em um raio de %s m"] = {StatLogic.Stats.GenericManaRegen, false, false, }
...
L["aumenta em até %s o dano causado e a cura realizada por feitiços e efeitos mágicos de todos os integrantes do grupo em um raio de %s m. este efeito específico não se acumula de várias fontes"] = {{StatLogic.Stats.HealingPower, StatLogic.Stats.SpellDamage, }, false, }
