...
L["te enseña a encantar de forma permanente una pieza de armadura de torso para que otorgue %s de maná"] = { { Stats.Mana, }, } -- s7443
L["te enseña a encantar de forma permanente un brazal para que otorgue %s de espíritu"] = { { Stats.Spirit, }, } -- s7766
L["te enseña a encantar de forma permanente una capa para otorgar %s p. extra de armadura"] = { { Stats.Armor, }, } -- s7771
L["te enseña a encantar de forma permanente un brazal para que otorgue %s de fuerza"] = { { Stats.Strength, }, } -- s7782
L["te enseña a encantar de forma permanente un arma de dos manos para que otorgue %s de intelecto"] = { { Stats.Intellect, }, } -- s7793
L["te enseña a encantar de forma permanente un par de botas para que otorguen %s de aguante"] = { { Stats.Stamina, }, } -- s7863
L["te enseña a encantar de forma permanente un par de botas para que otorguen %s de agilidad"] = { { Stats.Agility, }, } -- s7867
L["te enseña a encantar de forma permanente un arma de dos manos para que otorgue %s de espíritu"] = { { Stats.Spirit, }, } -- s13380
L["te enseña a encantar de forma permanente una capa para que otorgue %s de agilidad"] = { { Stats.Agility, }, } -- s13419
L["te enseña a encantar de forma permanente un escudo con %s de armadura"] = { { Stats.Armor, }, } -- s13464
L["te enseña a encantar de forma permanente una capa para que otorgue %s p. de resistencia a las sombras"] = { { Stats.ShadowResistance, }, } -- s13522
L["te enseña a encantar de forma permanente un brazal para que otorgue %s de índice de defensa"] = { { Stats.DefenseRating, }, } -- s13646
L["te enseña a encantar de forma permanente un par de botas para que otorguen %s de espíritu"] = { { Stats.Spirit, }, } -- s13687
L["te enseña a encantar de forma permanente un escudo para que otorgue %s de índice de bloqueo"] = { { Stats.BlockRating, }, } -- s13689
L["te enseña a encantar de forma permanente un escudo para que otorgue %s de aguante"] = { { Stats.Stamina, }, } -- s13817
L["te enseña a encantar de forma permanente un escudo para que otorgue %s de resistencia a la escarcha"] = { { Stats.FrostResistance, }, } -- s13933
L["te enseña a encantar de forma permanente un brazal para que otorgue %s de aguante"] = { { Stats.Stamina, }, } -- s13945
L["te enseña a encantar de forma permanente un brazal para que otorgue %s de intelecto"] = { { Stats.Intellect, }, } -- s20008
L["te enseña a encantar de forma permanente una capa para que aumente %s p. todas las resistencias"] = { { Stats.FireResistance, Stats.NatureResistance, Stats.FrostResistance, Stats.ShadowResistance, Stats.ArcaneResistance, }, } -- s20014
L["te enseña a encantar de forma permanente unos guantes para que otorguen %s de agilidad"] = { { Stats.Agility, }, } -- s20012
L["te enseña a encantar de forma permanente una pieza de armadura de torso para que otorgue %s de salud"] = { { Stats.Health, }, } -- s20026
L["te enseña a encantar de forma permanente un escudo para que otorgue %s de espíritu"] = { { Stats.Spirit, }, } -- s20016
L["te enseña a encantar de forma permanente una capa para que otorgue %s p. más de armadura"] = { { Stats.Armor, }, } -- s20015
L["te enseña a encantar de forma permanente unos guantes para que otorguen %s de fuerza"] = { { Stats.Strength, }, } -- s20013
L["te enseña a encantar de forma permanente un arma de dos manos para que inflija %s p. más de daño"] = { { Stats.AverageWeaponDamage, }, } -- s20030
L["te enseña a encantar de forma permanente un arma para que inflija %s p. más de daño"] = { { Stats.AverageWeaponDamage, }, } -- s20031
L["te enseña a encantar de forma permanente una pieza de armadura de torso para que otorgue %s a cada uno de los cinco atributos"] = { { Stats.AllStats, }, } -- s20025
L["te enseña a encantar de forma permanente un arma para que otorgue hasta %s p. más de daño de escarcha cuando se lanzan hechizos de escarcha"] = { { Stats.FrostDamage, }, } -- s21931
L["te enseña a encantar de forma permanente un arma para que agregue %s p. de daño a los hechizos"] = { { Stats.SpellPower, }, } -- s22749
L["te enseña a encantar de forma permanente un arma para que agregue hasta %s p. de sanación a los hechizos de sanación y %s p. de daño a los hechizos de daño"] = { { Stats.HealingPower, }, { Stats.SpellDamage, }, } -- s22750
L["te enseña a encantar de forma permanente un arma para que aumente tu fuerza %s p"] = { { Stats.Strength, }, } -- s23799
L["te enseña a encantar de forma permanente un arma para que aumente tu agilidad %s p"] = { { Stats.Agility, }, } -- s23800
L["te enseña a encantar de forma permanente un brazal para que restaure %s p. de maná cada %s s"] = { { Stats.GenericManaRegen, }, false, } -- s23801
L["te enseña a encantar de forma permanente un brazal para que aumente %s p. los efectos de los hechizos de sanación y %s p. los de los hechizos de daño"] = { { Stats.HealingPower, }, { Stats.SpellDamage, }, } -- s23802
L["te enseña a encantar de forma permanente un arma para que aumente tu espíritu %s p"] = { { Stats.Spirit, }, } -- s23803
L["te enseña a encantar de forma permanente un arma para que aumente tu intelecto %s p"] = { { Stats.Intellect, }, } -- s23804
L["te enseña a encantar de forma permanente unos guantes para que aumenten %s p. el daño de las sombras infligido por hechizos y facultades"] = { { Stats.ShadowDamage, }, } -- s25073
L["te enseña a encantar de forma permanente unos guantes para que aumenten %s p. el daño de escarcha infligido por hechizos y facultades"] = { { Stats.FrostDamage, }, } -- s25074
L["te enseña a encantar de forma permanente unos guantes para que aumenten %s p. el daño de fuego infligido por hechizos y facultades"] = { { Stats.FireDamage, }, } -- s25078
L["te enseña a encantar de forma permanente unos guantes para que aumenten %s p. la sanación realizada por hechizos y facultades y %s p. el daño de los hechizos de daño"] = { { Stats.HealingPower, }, { Stats.SpellDamage, }, } -- s25079
L["te enseña a encantar de forma permanente una capa para que aumente %s p. la resistencia al fuego"] = { { Stats.FireResistance, }, } -- s25081
L["te enseña a encantar de forma permanente una capa para que aumente %s p. la resistencia a la naturaleza"] = { { Stats.NatureResistance, }, } -- s25082
L["te enseña a encantar de forma permanente una capa para que otorgue %s p. de índice de esquivar"] = { { Stats.DodgeRating, }, } -- s25086
L["te enseña a encantar de forma permanente un arma de dos manos para que aumente tu agilidad %s p"] = { { Stats.Agility, }, } -- s27837
L["te enseña a encantar de forma permanente un brazal para darle %s de índice de defensa"] = { { Stats.DefenseRating, }, } -- s27906
...
L["te enseña a encantar de forma permanente un brazal para restaurar %s p. de maná cada %s s"] = { { Stats.GenericManaRegen, }, false, } -- s27913
...
L["te enseña a encantar de forma permanente un escudo para otorgar %s de índice de bloqueo"] = { { Stats.BlockRating, }, } -- s27946
