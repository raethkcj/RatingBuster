...
L["StatIDLookup"] = {
	...
	["Mejora tu probabilidad de alcanzar el objetivo%"] = {"MELEE_HIT"},
	["índice de golpe"] = {"MELEE_HIT_RATING",},
	["Mejora el índice de golpe"] = {"MELEE_HIT_RATING",}, -- ITEM_MOD_HIT_RATING
	["Mejora el índice de golpe cuerpo a cuerpo"] = {"MELEE_HIT_RATING",}, -- ITEM_MOD_HIT_MELEE_RATING
	["Aumenta tu índice de golpe"] = {"MELEE_HIT_RATING",},
	...
	["Mejora tu probabilidad de conseguir un golpe crítico en%"] = {"MELEE_CRIT"},
	...
	["Mejora el índice de celeridad"] = {"MELEE_HASTE_RATING"},
	["Aumenta el índice de celeridad"] = {"MELEE_HASTE_RATING"},
	["Aumenta tu índice de celeridad"] = {"MELEE_HASTE_RATING"},
