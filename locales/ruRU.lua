...
L["Include block chance in Avoidance"] = "Включать вероятность блока в итоге избежаний"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "Включать вероятность блока в итоге избежаний, отключение только для уклона, парирования, промоха"
...
L["Hit Chance <- Hit Rating, Weapon Skill Rating"] = "Рейтинг меткости -> Вероятность поподания"
L["Crit Chance <- Crit Rating, Agility, Weapon Skill Rating"] = "Рейтинг крит. удара, ловкость -> Вероятность крит. удара"
L["Haste <- Haste Rating"] = "Рейтинг скорости -> Скорость"
L["Ranged Hit Chance <- Hit Rating, Weapon Skill Rating, Ranged Hit Rating"] = "Рейтинг меткости, рейтинг меткости дальнего боя -> Вероятность поподания в дальнем бою"
L["Ranged Crit Chance <- Crit Rating, Agility, Weapon Skill Rating, Ranged Crit Rating"] = "Рейтинг крита, ловкость, рейтинг крит. удара дальнего боя -> Вероятность крит. удара в дальнем бою"
...
L["Mana Regen <- Mana Regen, Spirit"] = "Восстановление маны, дух -> Восстановление маны в бою"
L["Mana Regen while not casting <- Spirit"] = "Дух -> Сумма восстановления маны вне боя"
L["Health Regen <- Health Regen"] = "Восстановление здоровья -> Восстановление здоровья в бою"
L["Health Regen when out of combat <- Spirit"] = "Дух -> Сумма восстановления здоровья вне боя"
L["Armor <- Armor from items, Armor from bonuses, Agility, Intellect"] = "Броня с одежды и бонусов -> Броня"
L["Block Value <- Block Value, Strength"] = "Block Value <- Block Value, Strength"
L["Dodge Chance <- Dodge Rating, Agility, Defense Rating"] = "Рейтинг уклонения, ловкость -> Вероятность уклонения"
L["Parry Chance <- Parry Rating, Defense Rating"] = "Рейтинг парирования -> Вероятность парирования"
L["Block Chance <- Block Rating, Defense Rating"] = "Рейтинг блокирования -> Вероятность блокирования"
...
L["Dodge Reduction <- Expertise, Weapon Skill Rating"] = "Игнорирование уклонения <- Мастерство"
L["Parry Reduction <- Expertise, Weapon Skill Rating"] = "Игнорирование парирования <- Мастерство"
...
L["Avoidance <- Dodge, Parry, Miss, Block (Optional)"] = "Уклонение от удара <- Уклонение, Парирование, ПромахСущества, Блок(дополнительный)"
L["Gems"] = "Набор"
...
L["statPatterns"] = {
	...
	[StatLogic.Stats.AttackPower] = { "сила атаки", "силу атаки", "силы атаки", "силы вашей атаки", "к силе атаки" },
	[StatLogic.Stats.RangedAttackPower] = { "сила атаки", "силу атаки", "силы атаки", "силы вашей атаки", "к силе атаки" },
	[StatLogic.Stats.FeralAttackPower] = { "сила атаки", "силу атаки", "силы атаки", "силы вашей атаки", "к силе атаки" },
	...
	[StatLogic.Stats.HighestSecondary] = { "искусности", "искусность", "искусност", "рейтинг скорости", "рейтингу скорости", "рейтинга скорости", "скорости", "скорость", "рейтинг критического удара", "к рейтингу критического эффекта", "рейтингу критического удара", "рейтинга критического удара", "к показателю критического удара", },
