...
L["statPatterns"] = {
	...
	[StatLogic.Stats.MeleeHitRating] = { "рейтинга нанесения удара ближнего боя", "рейтинг меткости", "рейтинга меткости", "рейтингу меткости", "меткости" },
	...
	[StatLogic.Stats.MeleeHasteRating] = { "рейтинг скорости", "рейтингу скорости", "рейтинга скорости", "скорости" },
