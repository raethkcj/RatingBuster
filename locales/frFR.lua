...
L["Include block chance in Avoidance"] = "Blocage dans Évitement"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "Inclue les chances de blocage au total d'Évitement, en plus de l'esquive, de la parade et du raté.\n\nUtile pour les tanks qui utilisent un bouclier."
...
L["Avoidance <- Dodge, Parry, Miss, Block (Optional)"] = "Inclure l'Évitement conféré par : Esquive + Parade + Raté + Blocage(optionnel)."
L["Gems"] = "Gemmes"
...
L["statPatterns"] = {
	...
	[StatLogic.Stats.AttackPower] = { "puissance d'attaque" },
	[StatLogic.Stats.RangedAttackPower] = { "puissance d'attaque" },
	[StatLogic.Stats.FeralAttackPower] = { "puissance d'attaque" },
	...
	[StatLogic.Stats.HighestSecondary] = { "maîtrise", "score de hâte", "hâte", "score de critique", "score de crit.", "score de coup critique", "score de toucher critique", },
