...
L["Include block chance in Avoidance"] = "Include block chance in Avoidance"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"
...
L["Avoidance <- Dodge, Parry, Miss, Block (Optional)"] = "Avoidance <- Dodge, Parry, Miss, Block (Optional)"
L["Gems"] = "Gems"
...
L["statPatterns"] = {
	...
	[StatLogic.Stats.Primary] = { "atributo útil" },
