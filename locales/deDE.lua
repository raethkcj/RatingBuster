...
L["Include block chance in Avoidance"] = "Zeige Blockchance in Vermeidungsübersicht"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "Zeige Blockchance in Vermeidungsübersicht, deaktivieren um nur Ausweichen, Parieren und Verfehlen zu zeigen"
...
L["Avoidance <- Dodge, Parry, Miss, Block (Optional)"] = "Vermeidung <- Ausweichen, Parieren, MobMiss, Block(Optional)"
L["Gems"] = "Edelsteine"
...
L["statPatterns"] = {
	...
	[StatLogic.Stats.HighestSecondary] = { "meisterschaft", "tempowertung", "tempo", "kritische trefferwertung", "kritischer trefferwert", "angriffstempowertung", },
