...
L["Include block chance in Avoidance"] = "傷害迴避包含格檔率"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "開啟時傷害迴避包含格檔率，關閉時有閃躲、招架、未擊中"
L["Stat - Basic"] = "統計基本屬性"
...
L["statPatterns"] = {
	...
	[StatLogic.Stats.BlockRating] = { "格擋等級", "格擋" },
