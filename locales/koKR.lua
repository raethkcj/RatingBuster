...
L["Include block chance in Avoidance"] = "회피 요약에 방어율 포함"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "회피 요약에 방어율을 포함시킵니다. 회피, 무기 막기, 빗맞힘만 사용하려면 비활성화하세요."
L["Stat - Basic"] = "능력치 - 기본"
...
L["Avoidance <- Dodge, Parry, Miss, Block (Optional)"] = "회피량 <- 회피, 무기 막기, 몹빗맞힘, 방어(선택적)"
L["Gems"] = "보석"
