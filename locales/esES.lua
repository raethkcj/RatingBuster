...
L["Include block chance in Avoidance"] = "Incluir prob. de bloqueo en resumen de Eludir"
L["Enable to include block chance in Avoidance, Disable for only dodge, parry, miss"] = "Incluye prob. de bloqueo en resumen de Eludir, Deshabilita para solo esquivar, parar y fallar"
...
L["Avoidance <- Dodge, Parry, Miss, Block (Optional)"] = "Elusion <- Esquivar, Parar, FalloEnemigo, Bloqueo(Opcional)"
L["Gems"] = "Gems"
...
L["statPatterns"] = {
	...
	[StatLogic.Stats.HighestSecondary] = { "maestría", "índice de velocidad de lanzamiento de ataques", "celeridad", "índice de golpe crítico", "golpe crítico", },
